...
const scriptTags=scripts.filter(script=>script!=='assets/operations-dashboard.js').map(script=>'<script src="'+(script==='assets/supabase-client.js'?'assets/preview-fixtures.js':script)+'"></script>').join('\n');
